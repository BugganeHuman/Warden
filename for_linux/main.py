...
def main():
    ...
    elements_frame.bind("<Button-4>", lambda e: elements_frame._parent_canvas.yview_scroll(-1, "units"))
    elements_frame.bind("<Button-5>", lambda e: elements_frame._parent_canvas.yview_scroll(1, "units"))
    ...
    for event in ("<Motion>", "<Button>", "<Key>"):
    ...
    def creat_vault_widgets():
        ...
        def show_elements():
            ...
            for element in operations.show_elements():
                ...
                widgets = (link_label, login_label, password_label, check_btn, delete_btn, update_btn)
                for w in widgets:
                    # Button-4 — скролл вверх, Button-5 — скролл вниз
                    w.bind("<Button-4>", lambda e: elements_frame._parent_canvas.yview_scroll(-1, "units"))
                    w.bind("<Button-5>", lambda e: elements_frame._parent_canvas.yview_scroll(1, "units"))
